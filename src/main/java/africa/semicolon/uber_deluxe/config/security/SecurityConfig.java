package africa.semicolon.uber_deluxe.config.security;


import africa.semicolon.uber_deluxe.config.security.filters.UberDeluxeAuthenticationFilter;
import africa.semicolon.uber_deluxe.config.security.filters.UberDeluxeAuthorizationFilter;
...
public class SecurityConfig {
    ...
    private final String[] AUTHENTICATION_WHITE_LIST = {"/api/v1/driver/**", "/api/v1/**"};
    @Bean
