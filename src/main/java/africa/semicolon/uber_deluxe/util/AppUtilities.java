package africa.semicolon.uber_deluxe.util;
...
public class AppUtilities {
    ...
    public static  final String WELCOME_MAIL_TEMPLATE_LOCATION="C:\\Users\\Admin\\Downloads\\uber_deluxe\\uber_deluxe\\src\\main\\resources\\welcome.txt";

    public static final String EMAIL_REGEX_STRING="^[A-Za-z0-9+_.-]+@(.+)$";
    public static final String ADMIN_INVITE_MAIL_TEMPLATE_LOCATION="C:\\Users\\Admin\\Downloads\\uber_deluxe\\uber_deluxe\\src\\main\\resources\\adminMail.txt";

    public static final String JSON_CONSTANT="json";

    public static final String TRANSPORT_MODE="driving";

    public static final String UBER_DELUXE_TEST_IMAGE="C:\\Users\\Admin\\Downloads\\uber_deluxe\\uber_deluxe\\src\\main\\resources\\th.webp";
